...
Главный экран использует карту-схему и боковую панель в духе [Electricity Maps](https://app.electricitymaps.com/map/zone/DE/72h/fifteen_minutes): две выбираемые турбины, переключатель мощности/ветра и почасовая лента с воспроизведением. Выбор часа синхронизирован с графиками и таблицей. Работают дата выпуска, горизонт 24/48 часов, фильтр турбин и выгрузка демо CSV. Карта — условная схема, а не настоящая топография или погодный слой. Макет адаптируется к мобильному экрану.
