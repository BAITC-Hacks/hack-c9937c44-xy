...
Откройте **http://127.0.0.1:8765/preview/**. Сервер запускается из корня проекта, чтобы панель могла читать `outputs/`. Сборка и JavaScript-зависимости не нужны.
