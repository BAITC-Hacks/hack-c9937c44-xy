...
Откройте **http://127.0.0.1:8765/preview/**. Сервер запускается из корня репозитория, чтобы интерфейс мог читать `outputs/demo/` и `outputs/backtest/`. Сборка и JavaScript-зависимости не нужны.
