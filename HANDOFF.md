...
Источник «Демо интерфейса» генерирует отдельный синтетический сценарий прямо в браузере. Карта MapLibre показывает две турбины на подложке OpenFreeMap; для подложки нужен интернет. Без карты доступны карточки и расчёты. Есть выбор мощности/ветра, выбранного часа и почасовое воспроизведение; координаты требуют подтверждения.
