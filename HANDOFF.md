...
После добавления отчётов на Windows/Python 3.11 прошёл **51 тест**, без пропусков. В браузере проверены генерация демо и Python-артефактов, горизонты 24/48 ч, сброс старого отчёта при смене параметров и мобильная компоновка; PDF проверен визуально. Январский эксперимент и его метрики ниже относятся к предыдущей проверке на Mac.
